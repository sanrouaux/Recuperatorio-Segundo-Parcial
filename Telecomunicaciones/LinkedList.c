...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this != NULL && index >= 0 && index < ll_len(this))
    {
        ...
        Node* pNodoSiguiente;
        pNodoSiguiente = pNodo->pNextNode;
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    if(this != NULL && this2 != NULL)
    {
        ...
        for(i = 0; i < ll_len(this2); i++)
        {
            ...
            r = ll_contains(this, pNodo->pElement);
            if(r == 0)
            {
                returnAux = 0;
                break;
...
/** \brief Filtra una lista ligada de acuerdo al criterio pasado como parametro a traves de una funcion
 *
 * \param this LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return filteresList LinkedList* Punbtero a una nueva lista que contiene los elementos que pasaron el filtro
 *
 */
LinkedList* ll_filter(LinkedList* this, int (*pFunc)(void*))
{
    ...
    if(this != NULL && ll_len(this) > 0 && pFunc != NULL)
    {
        ...
        for(i = 0; i < ll_len(this); i++)
        {
            ...
            {
                ll_add(filteredList, pNode->pElement);
            }
        }
    }
    return filteredList;
